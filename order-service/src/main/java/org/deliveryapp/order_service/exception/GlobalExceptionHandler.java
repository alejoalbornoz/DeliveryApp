...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleMenuItemUnavailable(
    ...
    public ResponseEntity<Map<String, Object>> handleRestaurantServiceUnavailable(
            RestaurantServiceUnavailableException ex) {
